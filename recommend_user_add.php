                ...
                <form class="pure-form">
                    ...
                    <table class="pure-table pure-table-none" style="width: 80%">
                        ...
                        <tr>
                            ...
                            <td>用户名称</td>
                            <td><input id="name" name="user-name" type="text" placeholder="" class="input-form">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="color-red">*</td>
                            <td>用户邮箱</td>
                            <td><input id="email" name="user-email" type="text" placeholder="" class="input-form">
                            </td>
                        </tr>
...
<script type="text/javascript">
    $('#submit').on('click',function(){
        $.post('ajax/mail_user_register.php',{
            email:$('#email').val(),
            name:$('#name').val()
        },function(json){
