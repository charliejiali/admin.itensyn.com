...
$result=Tensyn::get_history_list($offset,$pagecount,$_GET);
$list=$result["data"];
$list_count=$result["count"];
$page_count=$result["page_count"];

$system_year=array("2017","2018","2019","2020","2021","2022");
                    ...
                    <div class="table-list">
                        <div id="table-data">
                            <table class="pure-table pure-table-line pure-table-striped pure-table-hover" style="width: 20000px">
                                ...
                                <tr >
                                    <td class="td-head"><a href="history_info.php?mid=<?php echo $l["media_id"].'&tid='.$l["tensyn_id"];?>"><?php echo $l["program_name"];?></a></td>
...
<!--                    </div>-->
    ...
    <script type="text/javascript">
        ...
        $('#btn_search').on('click',function(){
            ...
            window.location.href='history_list.php?'+$.param(params);
        });
