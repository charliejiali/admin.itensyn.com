...
<div style="width: 100%; font-size: 14px;  font-family: '微软雅黑', 'Microsoft YaHei', STHeiti, SimHei, Helvetica, Arial, Tahoma, sans-serif;">
    <table width="800" border="0" cellpadding="5" cellspacing="0" style="border: 1px solid #cccccc; margin: 20px auto; font-family: '微软雅黑', 'Microsoft YaHei', STHeiti, SimHei, Helvetica, Arial, Tahoma, sans-serif;">
        <tr>
