...
<div class="pure-menu menu-mode">
    <ul class="pure-menu-list">
        ...
        <li class="pure-menu-item top-ten <?php if ($pageNavId == 2) {echo " pure-menu-selected";} ?>">
            ...
            <a href="media_upload/movie_edit.php" class="pure-menu-link <?php if ($pageNavSub == 27) {echo " active";} ?>">补充媒体数据</a>
        ...
        <li class="pure-menu-item <?php if ($pageNavId == 3) {echo " pure-menu-selected";} ?>"><a href="media_download.php" class="pure-menu-link"><span class="icon-audit ico-data"></span>待人工采集数据</a></li>
        <li class="pure-menu-item top-ten <?php if ($pageNavId == 3) {echo " pure-menu-selected";} ?>">
            <a href="media_download.php" class="pure-menu-link <?php if ($pageNavSub == 31) {echo " active";} ?>">已爬完剧目列表下载</a>
