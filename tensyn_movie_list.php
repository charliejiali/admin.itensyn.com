                    ...
                    <div id="table-data">
                        <table class="pure-table pure-table-line pure-table-striped pure-table-hover" style="width: 18600px">
                            ...
                            <tbody>
                                ...
                                <tr >
                                <td class="td-head"><a href="movie_info.php?id=<?php echo $l["program_id"];?>"><?php echo $l["program_name"];?></a></td>
                                ...
                                <?php 
                                    ...
                                    $platform=$l["platform"];
                                    $attachs=Tensyn::check_attachs($program_id,$program_default_name,$platform);
                                    // $attachs=Tensyn::check_attachs($program_id,$tprogram_id);
                                ...
                                <td> 
                                 ...
                                 <?php } ?>
                                <td class="td-control">
                                    <!-- <button type="submit" class="pure-btn btn-small">通过</button> -->
                                    <button id="delete_<?php echo $l["tprogram_id"];?>" name="delete" type="button" class="pure-btn btn-small">删除</button>
                                </td>
                                <?php } ?>
                            </tbody>
                        </table>
