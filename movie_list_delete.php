...
$result = Program::get_delete_list($offset, $pagecount);
$list = $result["data"];
...
<head>
    ...
    <script src="./js/pages/movie_list_delete.js" type="text/javascript"></script>
                    ...
                    <div class="pure-u-1-3">
                        ...
                        <select class="form-control" id="select_year" style="width:90px">
                            ...
                            <?php foreach ($system_year as $sy) { ?>
                                <option value="<?php echo $sy; ?>" <?php if ($sy == $_GET["year"] && trim($_GET["year"]) !== "") {
                                    echo "selected";
                                } ?> ><?php echo $sy; ?></option>
                            <?php } ?>
                        </select>
                        ...
                        <select class="form-control" id="select_season" style="width:90px">
                            ...
                            <?php foreach ($system_season as $ss) { ?>
                                <option value="<?php echo $ss; ?>" <?php if ($ss == $_GET["season"] && trim($_GET["season"]) !== "") {
                                    echo "selected";
                                } ?> ><?php echo $ss; ?></option>
                            <?php } ?>
                        </select>
...
<script type="text/javascript">
    ...
    $('#search').on('click', function () {
        ...
        window.location.href = 'movie_list_delete.php?' + $.param(params);
    });
