...
class Iteration2{
	...
	private static $make=array(
		...
		"make2"=>array( // 男主演代表作单集播放量
			"weight"=>0.2,
			"range"=>array(0,2000,6300,10000),
			"score"=>array(1,2,3,4),
			"comment"=>"男主演代表作品播放量级为value万"
		),
		"make3"=>array( // 女主演代表作单集播放量
			"weight"=>0.2,
			"range"=>array(0,2000,6100,10000),
			"score"=>array(1,2,3,4),
	...
	private static $IP=array(
		...
		"IP2"=>array( // 原著贴吧关注量
			"weight"=>0.2,
			"range"=>array(0,30,71,120),
			"score"=>array(1,2,3,4),
			"comment"=>"原著贴吧关注度为value"
		),
		"IP4"=>array( // 上季节目微博粉丝数
			"weight"=>0.2,
			"range"=>array(0,17,30,65),
			"score"=>array(1,2,3,4),
			"grade"=>array("平庸作品","一般影响效果作品","热门影响力作品","现象级影响力作品"),
	...
	private static $topic=array(
		"topic1"=>array( // 男主过往代表作微博话题量
			"weight"=>0.15,
			"range"=>array(0,180000,400000,400000),
			"score"=>array(1,2,3,4),
		...
		"topic3"=>array( // 男主官方贴吧发帖数
			"weight"=>0.15,
			"range"=>array(0,80,350,600),
			"score"=>array(1,2,3,4)
		),
		"topic4"=>array( // 女主官方贴吧发帖数
			"weight"=>0.15,
			"range"=>array(0,79,350,600),
			"score"=>array(1,2,3,4)
		),
		"topic6"=>array( // 前季微博话题量
			"weight"=>0.2,
			"range"=>array(0,32800,65700,800000),
			"score"=>array(1,2,3,4),
			"grade"=>array("四线关注平庸小明星","三线关注度一般明星","二线高关注度明星","话题活跃的明星"),
