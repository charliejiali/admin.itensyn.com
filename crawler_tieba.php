...
$result=Crawler::get_tiebas($offset,$pagecount,$_GET);
$list=$result["data"];
...
<script type="text/javascript">
    ...
    $('a[id^="page"]').on('click',function(){
        ...
        window.location.href='crawler_tieba.php?'+$.param(params);
    });
    ...
    $('#new').on('click',function(){
        window.location.href='crawler_tieba_edit.php?act=add'
    });
    $('#table-head').on('click','a[id^="edit_"]',function(){
        window.location.href='crawler_tieba_edit.php?act=edit&name='+$(this).attr('id').split('_')[1];
    });
    $('#search').on('click',function(){
        window.location.href='crawler_tieba.php?q='+$.trim($('#q').val())
    });
    $('#q').on('keypress',function(e){
        if(e.keyCode==13){
            window.location.href='crawler_tieba.php?q='+$.trim($(this).val())
        }
    })
</script>
</body>
